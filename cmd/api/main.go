...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "2fb2a1942b12ab", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "80b24e7c53cf6e", "SMTP password")
